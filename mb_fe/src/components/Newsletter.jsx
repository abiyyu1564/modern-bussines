          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="text-white max-w-lg text-center md:text-left">
              ...
              <p className="text-blue-100 text-sm sm:text-base">
                Best cooks and best delivery huys all at your service. Hot tasty
                food
              </p>
            </div>

            {/* right content */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 ml-20">
              <input
                type="email"
              ...
              />
              <button className="w-full sm:w-auto cursor-pointer bg-green-500 text-white px-6 sm:px-8 py-3 xm:py-4 rounded-xl sm:rounded-l-none sm:rounded-r-lg flex items-center gap-2">
                <span>Discover</span>
